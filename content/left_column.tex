...
\begin{block}{Introduction and objectives}
	\begin{enumerate}
		...
		\item We present USSR: An UltraSound Sparse Regularization framework composed of:
		\begin{itemize}
			...
			\item Sparse regularization algorithm with two sparsity priors: $\ell_p$-norm to the power of $p$~($p \geq 1$), $\ell_1$-norm in a sparsity averaging~(SA) model
		\end{itemize}
